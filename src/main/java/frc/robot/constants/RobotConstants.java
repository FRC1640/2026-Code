...
public class RobotConstants {
    ...
    public class RobotTypes {
        ...
        public static final RobotType duex26 = new RobotType("Duex26",
                Subsystems.driveSubsystem,
                Subsystems.hopperSubsystem,
                Subsystems.indexerSubsystem,
                Subsystems.deflectorSubsystem,
                Subsystems.flywheelSubsystem,
                Subsystems.turretSubsystem
        );

        public static final RobotType frank25 = new RobotType("Frank25", Subsystems.driveSubsystem,
                Subsystems.turretSubsystem);
        public static final RobotType testbot = new RobotType("Test");
    }
