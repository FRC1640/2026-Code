...
public class RobotPIDConstants {
  ...
  public static final PIDConstants drivePid = Switchable.of(new PIDConstants(0.17189, 0.0, 0)).get();
  public static final FeedForwardConstants driveFF = Switchable.of(new FeedForwardConstants(0.12506, 2, 0.27879))
      .get();
  public static final PIDConstants steerPid = Switchable.of(new PIDConstants(0.725, 0.0, 0.005)).get();
  public static final PIDConstants intakeAnglePidReal = Switchable.of(new PIDConstants(3.5, 0, 0))
      .addAlt(RobotConstants.RobotTypes.prime26, new PIDConstants(0, 0, 0)).get();
  ...
  public static final PIDConstants turretProfiledPidReal = Switchable.of(new PIDConstants(2.1, 0, 0))
      .addAlt(RobotConstants.RobotTypes.prime26, new PIDConstants(0, 0, 0)).get();
  public static final Constraints turretAngleConstraintsReal = Switchable
      .of(new Constraints(4 * Math.PI, 6 * Math.PI))
      .addAlt(RobotConstants.RobotTypes.prime26, new Constraints(0, 0)).get();
  public static final FeedForwardConstants turretAngleFF = Switchable
      .of(new FeedForwardConstants(0, 0/* 1 / 1.06 */, 0))
      .addAlt(RobotConstants.RobotTypes.prime26, new FeedForwardConstants(0, 0/* 1 / 1.06 */, 0)).get();
