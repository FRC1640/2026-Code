...
public class RobotPIDConstants {
  ...
  public static final PIDConstants intakeAngleSim = new PIDConstants(0.5, 0, 0); // TODO: change
  ...
  public static final PIDConstants autoTurnPID = new PIDConstants(2, 0, 0);
