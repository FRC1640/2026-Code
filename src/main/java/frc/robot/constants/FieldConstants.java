...
public class FieldConstants {
  ...
  public static final Pose2d blueShootNorth = new Pose2d(
      new Translation2d(hubPositionBlue.getX() - 1.943 - 0.854 - 0.8, hubPositionBlue.getY() + 1.602 + 1.520 - 0.762),
      Rotation2d.kZero);
  ...
  public static final Pose2d redShootNorth = new Pose2d(
      new Translation2d(hubPositionRed.getX() + 1.943 + 0.854 + 0.8, hubPositionRed.getY() + 1.602 + 1.520 - 0.762),
      Rotation2d.kPi);
