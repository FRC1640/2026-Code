...
import frc.robot.util.helpers.PoseFilter.PoseFilterPreset;
...
public class FieldConstants {
  ...
  public static final PoseFilter blueAllianceZone = new PoseFilter(PoseFilterPreset.isPoseLeftOf(hubPositionBlue));
  public static final PoseFilter redAllianceZone = new PoseFilter(PoseFilterPreset.isPoseRightOf(hubPositionRed));
  public static final PoseFilter neutralZone = new PoseFilter(PoseFilterPreset.isPoseRightOf(hubPositionBlue))
      .addFilter(PoseFilterPreset.isPoseLeftOf(hubPositionRed));
  ...
  public static final PoseFilter rightBlueTrench = new PoseFilter(
      PoseFilterPreset.vectorFilterFunction(new Translation2d(1, 0), new Pose2d(4.125594, 0, new Rotation2d())))
  ...
  public static final PoseFilter leftBlueTrench = new PoseFilter(
      PoseFilterPreset.vectorFilterFunction(new Translation2d(1, 0), new Pose2d(4.125594, 0, new Rotation2d())))
          .addFilter(new Translation2d(-1, 0), new Pose2d(5.125594, 0, new Rotation2d()))
  ...
  public static final PoseFilter rightRedTrench = new PoseFilter(
      PoseFilterPreset.vectorFilterFunction(new Translation2d(1, 0), new Pose2d(11.318494, 0, new Rotation2d())))
  ...
  public static final PoseFilter leftRedTrench = new PoseFilter(
      PoseFilterPreset.vectorFilterFunction(new Translation2d(1, 0), new Pose2d(11.318494, 0, new Rotation2d())))
          .addFilter(new Translation2d(-1, 0), new Pose2d(12.512294, 0, new Rotation2d()))
