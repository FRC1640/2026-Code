...
public class SparkConstants {
    ...
    static {
        ...
        // LimitSwitchConfig hoodLimitSwitches = new LimitSwitchConfig().forwardLimitSwitchType(LimitSwitchConfig.Type.kNormallyOpen).forwardLimitSwitchTriggerBehavior(LimitSwitchConfig.Behavior.kStopMovingMotorAndSetPosition);
        hoodConfig = getDefaultMaxConfig();
        hoodConfig.closedLoop.feedbackSensor(FeedbackSensor.kAbsoluteEncoder).pid(1, 0, 0, ClosedLoopSlot.kSlot0);
        hoodConfig.closedLoop.apply(
          new MAXMotionConfig()
          .cruiseVelocity(Units.radiansPerSecondToRotationsPerMinute(HoodConstants.maxVelocityRadiansPerSecond))
          .allowedProfileError(Units.degreesToRotations(10))
          .maxAcceleration(Units.radiansPerSecondToRotationsPerMinute(HoodConstants.maxAccelerationRadiansPerSecond))
