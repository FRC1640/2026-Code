...
public class PPIDLog {
  public static void log() {
    ...
    for (String id : PPIDStorage.pidControllers.keySet()) {
      ...
      Logger.recordOutput(folder + PPIDStorage.getPID(id) + "/Period", PPIDStorage.getPID(id).getPeriod());
      ...
      Logger.recordOutput(folder + PPIDStorage.getPID(id) + "/IZone", PPIDStorage.getPID(id).getIZone());
