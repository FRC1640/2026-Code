...
public class PIDLog {
    public static void log() {
        ...
        for(String id : PIDStorage.pidControllers.keySet()) {
            ...
            Logger.recordOutput(folder + PIDStorage.getPID(id) + "/Accumulated Error", PIDStorage.getPID(id).getAccumulatedError());
            ...
            Logger.recordOutput(folder + PIDStorage.getPID(id) + "/Error Deriviative", PIDStorage.getPID(id).getErrorDerivative());
            Logger.recordOutput(folder + PIDStorage.getPID(id) + "/Error Deriv Tolerance", PIDStorage.getPID(id).getErrorDerivativeTolerance());
            Logger.recordOutput(folder + PIDStorage.getPID(id) + "/Error Tolerance", PIDStorage.getPID(id).getErrorTolerance());
        }
    }
}
