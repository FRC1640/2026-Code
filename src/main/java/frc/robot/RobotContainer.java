...
public class RobotContainer {
    ...
    private void generateTriggers() {
        ...
        new Trigger(() -> AllianceManager.chooseFromAlliance(FieldConstants.shooterTypeBluePoseFilter, FieldConstants.shooterTypeRedPoseFilter).poseSatisfies(RobotOdometry.instance.getPose("Main")))
