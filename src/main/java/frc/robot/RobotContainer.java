...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoPilotWeight = new AutoPilotWeight(
        () -> new APTarget(new Pose2d(AllianceManager.chooseFromAlliance(FieldConstants.blueTowerBarNorth,
            FieldConstants.redTowerBarNorth), new Rotation2d())),
  ...
  private void generateNamedCommands() {
    ...
    NamedCommands.registerCommand("TowerAlignAutopilot", DriveWeightCommand.create(driveSubsystem, () -> false)
        .until(() -> autoPilotWeight.isAtTarget()).withTimeout(2.0));
  }
