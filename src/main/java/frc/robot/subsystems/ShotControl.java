...
public class ShotControl {
  ...
  static {
    ...
    distanceToHoodAngleAZ.put(1.662, 15.0); // TOF = 0.75 s
    distanceToHoodAngleAZ.put(2.073, 15.0); // 2.33045
    distanceToHoodAngleAZ.put(2.540, 15.0);
    distanceToHoodAngleAZ.put(3.000, 16.4); // TOF = 0.8 s
    distanceToHoodAngleAZ.put(3.650, 20.0); // TOF = 0.925 s
    distanceToHoodAngleAZ.put(4.059, 24.8); // TOF = 1.25 s
    distanceToHoodAngleAZ.put(4.508, 27.2);
    distanceToHoodAngleAZ.put(5.076, 27.7);
    ...
    distanceToShooterVelocityAZ.put(1.662, 2500.0); //
    distanceToShooterVelocityAZ.put(2.073, 2575.0); // 2.33045
    distanceToShooterVelocityAZ.put(2.540, 2725.0);
    distanceToShooterVelocityAZ.put(3.000, 2900.0); //
    distanceToShooterVelocityAZ.put(3.650, 3050.0);
    distanceToShooterVelocityAZ.put(4.059, 3150.0); //
    distanceToShooterVelocityAZ.put(4.508, 3200.0); //
    distanceToShooterVelocityAZ.put(5.076, 3500.0); //
