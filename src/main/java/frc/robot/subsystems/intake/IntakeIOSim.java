...
public class IntakeIOSim implements IntakeIO {
    ...
    public IntakeIOSim() {
        ...
        intakeMotor = new DCMotorSim(LinearSystemId.createDCMotorSystem(
            simGearbox, 0.00019125, IntakeConstants.gearRatio),
            simGearbox); 
        }
@Override
