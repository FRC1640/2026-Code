...
public class IntakeConstants {
  ...
  public static final double intakeEncoderCount1 = Switchable.of(0.335 + intakeManualOffset).addAlt(RobotTypes.prime26, 0.349 + intakeManualOffset).get();
  public static final double intakeEncoderCount0 =  Switchable.of(0 + intakeManualOffset).addAlt(RobotTypes.prime26, 0 + intakeManualOffset).get();
